...
<div class="main-content" id="mainContent">
    ...
    <nav class="topbar d-flex align-items-center justify-content-between px-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="d-flex align-items-center gap-2" id="storePickerWrap">
                ...
                <select id="sidebarStorePicker" class="form-select form-select-sm border-0 bg-transparent fw-semibold"
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="dropdown" id="notifDropdown">
                <button class="btn btn-link text-dark p-0 position-relative" data-bs-toggle="dropdown"
                        id="bellBtn" aria-expanded="false" style="text-decoration:none">
                ...
                <div class="dropdown-menu dropdown-menu-end shadow border-0 p-0"
                    ...
                    <div id="notifList" style="max-height:380px;overflow-y:auto">
                        <div class="text-center text-muted py-4 small" id="notifEmpty">Tidak ada notifikasi baru</div>
                    </div>
                </div>
            </div>

            <div class="dropdown">
                <button class="btn btn-link text-dark dropdown-toggle d-flex align-items-center gap-2 p-0 text-decoration-none"
    ...
    <div class="px-4 pt-3">
        @if(session('success'))
            <div class="alert alert-success alert-dismissible fade show d-flex align-items-center gap-2 js-auto-dismiss">
