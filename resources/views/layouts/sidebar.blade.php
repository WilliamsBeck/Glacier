<nav class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <div class="collapse" id="masterMenu">
            <a href="{{ route('master.stores.index') }}"      class="sidebar-link sub-link"><i class="bi bi-shop"></i><span>Toko</span></a>
            <a href="{{ route('master.suppliers.index') }}"   class="sidebar-link sub-link"><i class="bi bi-truck"></i><span>Supplier</span></a>
            <a href="{{ route('master.ingredients.index') }}" class="sidebar-link sub-link"><i class="bi bi-box-seam"></i><span>Bahan Baku</span></a>
            <a href="{{ route('master.menus.index') }}"       class="sidebar-link sub-link"><i class="bi bi-cup-straw"></i><span>Menu & Resep</span></a>
            <a href="{{ route('master.categories.index') }}"  class="sidebar-link sub-link"><i class="bi bi-tags"></i><span>Kategori</span></a>
            <a href="{{ route('master.users.index') }}"       class="sidebar-link sub-link"><i class="bi bi-people"></i><span>User</span></a>
        </div>
        @endif
        ...
        <div class="collapse" id="mutasiMenu">
            <a data-base-href="{{ route('inventory.mutations.index') }}"
               href="{{ route('inventory.mutations.index') }}"
            ...
            <a data-base-href="{{ route('inventory.mutations.create') }}"
               href="{{ route('inventory.mutations.create') }}"
               class="sidebar-link sub-link"><i class="bi bi-plus-circle"></i><span>Input Mutasi</span></a>
            <a data-base-href="{{ route('inventory.stocks.index') }}"
            ...
            <a data-base-href="{{ route('inventory.daily-ledger.index') }}"
               href="{{ route('inventory.daily-ledger.index') }}"
               class="sidebar-link sub-link"><i class="bi bi-table"></i><span>Pencatatan Harian</span></a>
            <a data-base-href="{{ route('opname.opnames.index') }}"
               href="{{ route('opname.opnames.index') }}"
        ...
        <div class="collapse" id="prodWasteMenu">
            <a data-base-href="{{ route('production.logs.index') }}"
               href="{{ route('production.logs.index') }}"
               class="sidebar-link sub-link"><i class="bi bi-gear"></i><span>Produksi</span></a>
            <a data-base-href="{{ route('waste.logs.index') }}"
               href="{{ route('waste.logs.index') }}"
        ...
        <div class="collapse" id="hppMenu">
            <a data-base-href="{{ route('sales.monthly.index') }}"
               href="{{ route('sales.monthly.index') }}"
               class="sidebar-link sub-link"><i class="bi bi-cart3"></i><span>Penjualan</span></a>
            <a data-base-href="{{ route('sales.hpp.index') }}"
               href="{{ route('sales.hpp.index') }}"
...
<a href="{{ route('reports.laporan.index') }}" class="sidebar-link sub-link">
            ...
            <a data-base-href="{{ route('order-planning.index') }}"
               href="{{ route('order-planning.index') }}"
