...
@section('content')
    <div class="page-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('master.users.index') }}" class="btn btn-outline-secondary btn-sm"><i
    ...
    <div class="row g-3">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header fw-semibold">Data User</div>
                <div class="card-body">
                    <form method="POST"
                        ...
                        <div class="mb-3"><label class="form-label fw-semibold">Password
        ...
        @if(isset($user) && $user->role === 'admin_area')
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header fw-semibold">Akses Toko</div>
                    <div class="card-body">
                        ...
                        @forelse($user->stores as $s)
                            <div class="d-flex align-items-center px-2 py-1 border-bottom">
                                ...
                                <form method="POST" action="{{ route('master.users.revoke-store', [$user, $s]) }}" class="d-inline"
                                    onsubmit="return confirm('Cabut akses toko ini?')">
                                    @csrf @method('DELETE')
